...
def extract_market_features(
    ...
    Handles missing values gracefully without crashing.
    """
    if not historical_prices or len(historical_prices) < 5:
        ...
        return {
            ...
            "pe_ratio": fundamentals.pe_ratio if (fundamentals and fundamentals.pe_ratio) else 20.0,
            "roe": fundamentals.roe if (fundamentals and fundamentals.roe) else 15.0,
            "debt_to_equity": fundamentals.debt_to_equity if (fundamentals and fundamentals.debt_to_equity) else 0.3,
        }
    ...
    # Fundamental values with safe fallbacks
